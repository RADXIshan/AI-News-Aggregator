...
class DeepMindArticle(BaseModel):
    title: str
    description: str
    url: str
    guid: str
...
class DeepMindScraper:
    def __init__(self):
        ...
        self.rss_url = "https://deepmind.google/blog/rss.xml"
    ...
    def get_articles(self, hours: int = 24) -> List[DeepMindArticle]:
        ...
        for entry in feed.entries:
            ...
            if published_time >= cutoff_time:
                articles.append(DeepMindArticle(
...
if __name__ == "__main__":
    ...
    articles: List[DeepMindArticle] = scraper.get_articles(hours=100)
